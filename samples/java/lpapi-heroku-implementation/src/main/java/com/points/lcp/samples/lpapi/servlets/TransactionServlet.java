	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			if (rs.next()) {
				...
				String pic = transactionRequest.getAsJsonPrimitive("pic") != null 
					? "'"+transactionRequest.getAsJsonPrimitive("pic").getAsString()+"'" 
					: null;
				String transactionType = transactionRequest.getAsJsonObject("order") != null 
					? "'"+transactionRequest.getAsJsonObject("order").getAsJsonPrimitive("orderType").getAsString()+"'" 
					: null;
				String transactionDate = "'"+(transactionRequest.getAsJsonObject("order") != null 
